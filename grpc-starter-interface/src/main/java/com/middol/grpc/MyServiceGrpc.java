...
@javax.annotation.Generated(
    ...
    comments = "Source: MySercvice.proto")
public final class MyServiceGrpc {

  private MyServiceGrpc() {}

  public static final String SERVICE_NAME = "com.middol.grpc.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.middol.grpc.HelloRequest,
      com.middol.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.middol.grpc.HelloRequest.class,
      responseType = com.middol.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.middol.grpc.HelloRequest,
      com.middol.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.middol.grpc.HelloRequest, com.middol.grpc.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.middol.grpc.HelloRequest, com.middol.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.middol.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.middol.grpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.middol.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.middol.grpc.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.middol.grpc.HelloRequest,
                com.middol.grpc.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.middol.grpc.HelloReply sayHello(com.middol.grpc.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.middol.grpc.HelloReply> sayHello(
        com.middol.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.middol.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.middol.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.middol.grpc.HelloWorldProto.getDescriptor();
    }
